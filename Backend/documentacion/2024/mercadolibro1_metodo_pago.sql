...
CREATE TABLE `metodo_pago` (
  ...
  PRIMARY KEY (`id`),
  KEY `metodo_pago_usuario_id_cb94264f_fk_ecommerce_customuser_id` (`usuario_id`),
  CONSTRAINT `metodo_pago_usuario_id_cb94264f_fk_ecommerce_customuser_id` FOREIGN KEY (`usuario_id`) REFERENCES `ecommerce_customuser` (`id`)
